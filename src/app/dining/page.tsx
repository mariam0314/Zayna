...
const menuItems = [
  ...
  },
  {
    ...
    rating: 5.0,
    prepTime: "Immediate",
    image: "/placeholder-champagne.jpg",
  },
];
          ...
          {filteredItems.map((item) => (
            <div key={item.id} className="card-black rounded-2xl overflow-hidden">
              ...
              <div className="relative h-48 bg-gradient-to-br from-gold/20 to-gold/5 flex items-center justify-center">
                <ChefHat className="text-gold/50" size={48} />
