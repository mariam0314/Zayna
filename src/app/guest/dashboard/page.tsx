          ...
          <div className="flex justify-between items-start">
            <div>
              <h1 className="text-3xl font-bold text-gold mb-2">
                Welcome back, {session?.user?.name || guest?.name || "Guest"}!
              </h1>
          ...
          <div className="card-black p-6 rounded-2xl">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-foreground">{session?.user?.name || guest?.name || "Guest"}</p>
              </div>
              <div>
                <label className="text-sm text-foreground/60">Email</label>
                <p className="text-foreground">{session?.user?.email || guest?.email || "-"}</p>
              </div>
              <div>
